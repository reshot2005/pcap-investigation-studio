...
Substitutes pcap-investigation-studio, PCAP Investigation Studio, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("pcap_investigation_studio", "{slug_underscore}"),
    ("pcap-investigation-studio", "{slug_kebab}"),
    ("PCAP Investigation Studio", "{name}"),
    ("pcap-investigation-studio", "{slug_kebab}"),
    ("PCAP Investigation Studio", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
